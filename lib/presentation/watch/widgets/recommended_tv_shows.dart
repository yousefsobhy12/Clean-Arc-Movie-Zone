...
class RecommendedTvShows extends StatelessWidget {
  const RecommendedTvShows({super.key, required this.tvEntityId});
  final int tvEntityId;
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GenericDataCubit()
        ..getData<List<TvEntity>>(
          serviceLocator<GetRecommendedTvShowsUsecase>(),
          params: tvEntityId,
        ),
